...
const r = await fetch(url, { method: "PATCH", headers: h, body: JSON.stringify({ conversation_config: { agent: { prompt, first_message: FIRST_MESSAGE } } }) });
...
console.log("first_message:", j.conversation_config?.agent?.first_message?.slice(0, 60), "...");
