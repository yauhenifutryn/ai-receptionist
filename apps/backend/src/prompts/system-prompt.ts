...
export function buildSystemPrompt(args: BuildSystemPromptArgs): string {
  ...
  const sections = [
    ...
    section("Goal", [
      ...
      "2. Politely capture the caller's first name BEFORE answering the first substantive information request. One short sentence, ALWAYS in the language of the caller's most recent turn (never default to English for this question):",
